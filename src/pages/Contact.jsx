                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                          <a
                            ...
                            className={`inline-flex items-center font-medium bg-gradient-to-r ${slide.degrade} hover:opacity-90 text-white text-lg px-8 py-4 rounded-md shadow-lg hover:shadow-xl transition-all`}
                          >
